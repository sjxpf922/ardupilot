...
//¼ÇÂ¼MTI¡¢imuµÄacc_ef_ekf_blended
...
#define LOG_BASE_STRUCTURES \
    ...
    { LOG_ATTITUDE_MTI, sizeof( MTI_Attitude),\
      "MTI", "QccCffffffLLf", "TimeUS,Roll,Pitch,Yaw,GryX,GryY,GryZ,AccX,AccY,AccZ,Lat,Lng,Alt", "sddhkkkoooDUm", "FBBB???000GG0" },\
